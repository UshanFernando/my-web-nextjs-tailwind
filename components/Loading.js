    ...
    <div className="gradientBg w-screen h-screen justify-center items-center">
      ...
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center justify-center space-x-2 animate-pulse">
          <div class="bg-white p-2  w-8 h-8 rounded-full animate-bounce blue-circle"></div>
          <div class="bg-white p-2 w-8 h-8 rounded-full animate-bounce green-circle"></div>
          <div class="bg-white p-2  w-8 h-8 rounded-full animate-bounce red-circle"></div>
        </div>
      </div>
    </div>
  );
