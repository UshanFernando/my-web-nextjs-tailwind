...
function Profile() {
  return (
    <div className="max-w-4xl flex items-center w-full h-auto lg:h-screen flex-wrap mx-auto py-32 lg:my-0 drop-shadow-xl " id="profile">
      {/* <!--Main Col--> */}
      <motion.div
        id="profile"
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: viewportOnce }}
            className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center profile_bg"
          ></motion.div>
          ...
          <p className="mt-4  pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            <svg
      ...
      <motion.div
        ...
        viewport={{ once: viewportOnce }}
      >
        <Image src={me} className="rounded-none lg:rounded-lg shadow-2xl " />
      </motion.div>
    </div>
  );
}
