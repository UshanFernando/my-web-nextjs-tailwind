...
function Profile() {
  return (
    <div class="max-w-4xl flex items-center w-full h-auto lg:h-screen flex-wrap mx-auto py-32 lg:my-0 drop-shadow-xl " id="profile">
      {/* <!--Main Col--> */}
      <motion.div
        id="profile"
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: viewportOnce }}
            class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center profile_bg"
          ></motion.div>
          ...
          <p class="mt-4  pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 fill-current text-purple-700 pr-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            ...
            <span className="ml-2">Mount Lavinia</span>
          </p>
          <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ml-2">+94 7828 77077 / 070 3 627 628</span>
          </p>
          ...
          <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            ...
            <span className="ml-2"> ushansankalpafernando@gmail.com</span>
          </p>
      ...
      <motion.div
        class="w-full lg:w-2/5 hidden lg:block"
        variants={avatarAnimation}
        initial="hidden"
        whileInView="show"
        transition={{
        ...
        viewport={{ once: viewportOnce }}
      >
        <Image src={me} class="rounded-none lg:rounded-lg shadow-2xl " />
      </motion.div>
    </div>
  );
}
